...
typedef enum MEDIA_CONTAINER_FORMAT{
	...
	MEDIA_FORMAT_WAV = 32,
	MEDIA_FORMAT_FLAC = 33,
	MEDIA_FORMAT_CEDARA_MAX = 34,

	MEDIA_FORMAT_SONIVOX_MIN = 34,
	MEDIA_FORMAT_MID = 35,
	MEDIA_FORMAT_SONIVOX_MAX = 36,
}MEDIA_CONTAINER_FORMAT;

extern int audio_format_detect(unsigned char *buf, int buf_size);
extern int fd_audio_format_detect(unsigned char *buf, int buf_size);
