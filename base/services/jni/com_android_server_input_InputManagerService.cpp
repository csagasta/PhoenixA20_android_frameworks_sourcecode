...
static void android_server_InputManager_nativeKeyEnterMouseMode(JNIEnv* env, jclass clazz, jint ptr) 
{
    NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
    im->getInputManager()->getReader()->keyEnterMouseMode();
}

static void android_server_InputManager_nativeKeyExitMouseMode(JNIEnv* env, jclass clazz, jint ptr) 
{
	NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
    im->getInputManager()->getReader()->keyExitMouseMode();
}

static void android_server_InputManager_nativeKeySetMouseBtnCode(JNIEnv* env, jclass clazz,jint ptr,jint leftbtn,jint midbtn,jint rightbtn) 
{
	NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
    im->getInputManager()->getReader()->keySetMouseBtnCode((int)leftbtn,(int)midbtn,(int)rightbtn);
}

static void android_server_InputManager_nativeKeySetMouseDistance(JNIEnv* env, jclass clazz,jint ptr,jint distance) 
{
	NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
    im->getInputManager()->getReader()->keySetMouseDistance((int)distance);
}

static void android_server_InputManager_nativeKeySetMouseMoveCode(JNIEnv* env, jclass clazz,jint ptr,jint left,jint right,jint top,jint bottom) 
{
	NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
