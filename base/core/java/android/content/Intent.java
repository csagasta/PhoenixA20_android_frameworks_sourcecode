...
public class Intent implements Parcelable, Cloneable {
    ...
    /**
     * Broadcast Action: Display output changed. This is broadcast when the
     * display output format change
     * <p class="note">
     * This is a protected intent that can only be sent by the system.
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_DISPLAY_OUTPUT_CHANGED = "android.intent.action.DISPLAY_OUTPUT_CHANGED";
