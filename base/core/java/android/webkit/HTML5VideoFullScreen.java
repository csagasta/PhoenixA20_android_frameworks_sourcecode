...
public class HTML5VideoFullScreen extends HTML5VideoView
    ...
    SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback()
    {
        ...
        {
//            mPlayingWhenDestroyed = mPlayer.isPlaying();	//fixed by Bevis, do not restart play in inline mode.
            pauseAndDispatch(mProxy);
            // We need to set the display to null before switching into inline
            // mode to avoid error.
            mPlayer.setDisplay(null);
            reset();	//add by Bevis, reset media player when fullscreen video exited.
            mSurfaceHolder = null;
