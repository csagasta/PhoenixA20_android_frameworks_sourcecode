...
public class AudioManager {
	...
	*/
    ...
    public void setAudioDeviceActive(ArrayList<String> devices, String state){
        ...
        boolean enablePassThrough = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.ENABLE_PASS_THROUGH, 0) == 1;
        if (enablePassThrough && state.equals(AUDIO_OUTPUT_ACTIVE)) {
            DisplayManagerAw dm = (DisplayManagerAw) mContext.getSystemService(Context.DISPLAY_SERVICE_AW);
            boolean hdmi = dm.getDisplayOutputType(0)
